 ...
 *
 * DESCRIPTION
 *  Std DOMStringExtend wrapper support file
 *
...
use DOMStringExtend as PHP_DOMStringExtend;
use NxSys\Core\ExtensibleSystemClasses as StdLib;

/**
 * DOMStringExtend wrapper
 *
 ...
 *
 * @see \DOMStringExtend
 * @link http://php.net/manual/en/class.domstringextend.php
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DOMStringExtend implements StdLib\dom\IDOMStringExtend, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DOMStringExtend(...func_get_args()));
	}
