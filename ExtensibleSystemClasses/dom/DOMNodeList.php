 ...
 *
 * DESCRIPTION
 *  Std DOMNodeList wrapper support file
 *
...
use DOMNodeList as PHP_DOMNodeList;
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DOMNodeList implements \Traversable, \Countable, StdLib\dom\IDOMNodeList, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DOMNodeList(...func_get_args()));
	}
