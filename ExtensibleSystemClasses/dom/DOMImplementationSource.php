 ...
 *
 * DESCRIPTION
 *  Std DOMImplementationSource wrapper support file
 *
...
use DOMImplementationSource as PHP_DOMImplementationSource;
use NxSys\Core\ExtensibleSystemClasses as StdLib;

/**
 * DOMImplementationSource wrapper
 *
 ...
 * @link http://php.net/manual/en/class.domimplementationsource.php
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DOMImplementationSource implements StdLib\dom\IDOMImplementationSource, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DOMImplementationSource(...func_get_args()));
	}
