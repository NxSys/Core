 ...
 *
 * DESCRIPTION
 *  Std DOMErrorHandler wrapper support file
 *
...
use DOMErrorHandler as PHP_DOMErrorHandler;
use NxSys\Core\ExtensibleSystemClasses as StdLib;

/**
 * DOMErrorHandler wrapper
 *
 ...
 *
 * @see \DOMErrorHandler
 * @link http://php.net/manual/en/class.domerrorhandler.php
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DOMErrorHandler implements StdLib\dom\IDOMErrorHandler, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DOMErrorHandler(...func_get_args()));
	}
