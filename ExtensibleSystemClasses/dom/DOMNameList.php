 ...
 *
 * DESCRIPTION
 *  Std DOMNameList wrapper support file
 *
...
use DOMNameList as PHP_DOMNameList;
 ...
 *
 * @see \DOMNameList
 * @link http://php.net/manual/en/class.domnamelist.php
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DOMNameList implements StdLib\dom\IDOMNameList, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DOMNameList(...func_get_args()));
	}
