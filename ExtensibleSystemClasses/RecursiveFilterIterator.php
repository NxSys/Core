 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class RecursiveFilterIterator implements \Iterator, \Traversable, \OuterIterator, \RecursiveIterator, StdLib\IRecursiveFilterIterator, StdLib\IhasTraitDecorating
{
