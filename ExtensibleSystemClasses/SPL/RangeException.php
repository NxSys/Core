 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class RangeException extends StdLib\SPL\RuntimeException implements \Throwable, StdLib\SPL\IRangeException, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_RangeException(...func_get_args()));
	}
}
