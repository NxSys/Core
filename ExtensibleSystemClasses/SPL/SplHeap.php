 ...
 *
 * DESCRIPTION
 *  Std SplHeap wrapper support file
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class SplHeap implements \Iterator, \Traversable, \Countable, StdLib\SPL\ISplHeap, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_SplHeap(...func_get_args()));
	}
