...
use RecursiveIteratorIterator as PHP_RecursiveIteratorIterator;

/**
 * RecursiveIteratorIterator wrapper
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class RecursiveIteratorIterator implements \Iterator, \Traversable, \OuterIterator, StdLib\SPL\IRecursiveIteratorIterator, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_RecursiveIteratorIterator(...func_get_args()));
	}
