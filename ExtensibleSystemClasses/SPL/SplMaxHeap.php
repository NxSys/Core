 ...
 *
 * DESCRIPTION
 *  Std SplMaxHeap wrapper support file
 *
...
use SplMaxHeap as PHP_SplMaxHeap;
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class SplMaxHeap extends StdLib\SPL\SplHeap implements \Countable, \Traversable, \Iterator, StdLib\SPL\ISplMaxHeap, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_SplMaxHeap(...func_get_args()));
	}
