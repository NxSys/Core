 ...
 *
 * DESCRIPTION
 *  Std NoRewindIterator wrapper support file
 *
...
use NoRewindIterator as PHP_NoRewindIterator;
use NxSys\Core\ExtensibleSystemClasses as StdLib;

/**
 * NoRewindIterator wrapper
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class NoRewindIterator extends StdLib\SPL\IteratorIterator implements \OuterIterator, \Traversable, \Iterator, StdLib\SPL\INoRewindIterator, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_NoRewindIterator(...func_get_args()));
	}
