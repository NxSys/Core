 ...
 *
 * DESCRIPTION
 *  Std Directory wrapper support file
 *
...
use Directory as PHP_Directory;
 ...
 *
 * @see \Directory
 * @link http://php.net/manual/en/class.directory.php
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class Directory implements StdLib\standard\IDirectory, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_Directory(...func_get_args()));
	}
	...
	public function close($dir_handle)
	{
		...
		$pfqcn='NxSys\Core\ExtensibleSystemClasses\standard\\'.get_class($ret);
