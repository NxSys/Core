 ...
 *
 * DESCRIPTION
 *  Std ReflectionType wrapper support file
 *
...
use ReflectionType as PHP_ReflectionType;

/**
 * ReflectionType wrapper
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class ReflectionType implements StdLib\Reflection\IReflectionType, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_ReflectionType(...func_get_args()));
	}
