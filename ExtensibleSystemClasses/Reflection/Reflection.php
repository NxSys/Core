 ...
 *
 * DESCRIPTION
 *  Std Reflection wrapper support file
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class Reflection implements StdLib\Reflection\IReflection, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_Reflection(...func_get_args()));
	}
