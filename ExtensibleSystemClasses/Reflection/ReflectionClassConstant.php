...
use ReflectionClassConstant as PHP_ReflectionClassConstant;

/**
 * ReflectionClassConstant wrapper
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class ReflectionClassConstant implements \Reflector, StdLib\Reflection\IReflectionClassConstant, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_ReflectionClassConstant(...func_get_args()));
	}
