 ...
 *
 * DESCRIPTION
 *  Std DatePeriod wrapper support file
 *
...
use DatePeriod as PHP_DatePeriod;
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DatePeriod implements \Traversable, StdLib\date\IDatePeriod, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DatePeriod(...func_get_args()));
	}
