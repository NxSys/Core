 ...
 *
 * DESCRIPTION
 *  Std DateTime wrapper support file
 *
 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class DateTime implements \DateTimeInterface, StdLib\date\IDateTime, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_DateTime(...func_get_args()));
	}
