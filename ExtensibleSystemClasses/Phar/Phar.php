 ...
 * @author Chris R. Feamster <cfeamster@f2developments.com>
 */
class Phar extends StdLib\Phar\RecursiveDirectoryIterator implements \RecursiveIterator, \SeekableIterator, \Traversable, \Iterator, \Countable, \ArrayAccess, StdLib\Phar\IPhar, StdLib\IhasTraitDecorating
{
	...
	{
		$this->_refreshTarget(new PHP_Phar(...func_get_args()));
	}
	...
	public function __destruct()
	{
		...
		$pfqcn='NxSys\Core\ExtensibleSystemClasses\Phar\\'.get_class($ret);
